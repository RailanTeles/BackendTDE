...
class ProcedimentoDao(Comandos):
    ...
    def adicionarProcedimento(self, procedimento: Procedimento):
        self.conectar()
        self.obterRegistro(
            "INSERT INTO Procedimentos (nome, desc, valorPlano, valorParticular) VALUES (?, ?, ?, ?)", 
    ...
    def alterarProcedimento(self, procedimento: Procedimento):
        self.conectar()
        self.obterRegistro(
            "UPDATE Procedimentos SET nome=?, desc=?, valorPlano=?, valorParticular=? WHERE id=?", 
